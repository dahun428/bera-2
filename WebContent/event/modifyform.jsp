						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									<td colspan="4">
										<div>
											<input type="radio" name="event-manager" id="event-manager-event" checked="checked" disabled="disabled"/><span>이벤트 등록</span>
											<input type="radio" name="event-manager" id="event-manager-banner" dis /><span>배너 등록</span>
										</div>
									</td>
								</tr>
								<!-- event thumbnail -->
									...
									<td colspan="4">
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
												id="event-thumbnail-checkbox" value="thumbnail" disabled="disabled"
