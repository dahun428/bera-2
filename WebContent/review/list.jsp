...
<div class="col-12 text-center">
	...
	<div class="row custom-review-content-box">
		...
		<div class="col-3 custom-review-img-box">
			<!-- review-content-img -->
			<div>
				<a onclick="openPopup(<%=reviewDto.getNo() %>)" href="data.jsp?reviewNo=" <%=reviewDto.getNo() %>
			...
			<div class="row no-gutters">
				...
				<div class="col-12">
							...
							<div class="modal-footer">
								...
								%>
								<a href="../review/modifyform.jsp?reviewNo=<%=productNo %>" class="btn btn-primary">수정</a>
								<a href="../review/deletereview.jsp?productNo=&reviewNo="
