                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-2 text-center">
                                ...
                                <a href="detail.jsp">
                                    <!-- product-detail-page-move --> <img class="img-thumbnail" src="../image/amond-bongbong.jpg" alt="" />
                                </a>
                            ...
                            <div class="col-2 text-center">
                                <span class="badge badge-pill badge-info">1위</span> <a href="#">
                                    <img class="img-thumbnail" src="../image/amond-bongbong.jpg" alt="" />
                                </a>
                                <div class="title text-center">
                                    <p>
                                        <a href="#">아몬드봉봉</a>
                            ...
                            <div class="col-3 list-box">
                                <div class="card" id="product-list-<%=product.getNo()%>" style="height: 340px; font-size: 8px;">
                                    <div class="card-body">
                                        ...
                                        <img class="card-img-top" src="../image/<%="ICECREAM".equals(cat) ? "ICECREAM":"CAKE" %>/<%=product.getImagePath()%>" alt="" />
                                    </div>
                                </div>
                                <%
									if (tags.size() > 2) {
