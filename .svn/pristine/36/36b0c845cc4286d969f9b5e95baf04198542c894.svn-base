				...
				<div class="custom-content-box">
					...
					<form action="../order/credit.jsp" method="post" id="cart-form">
						<div class="row content-header">
							...
							<div class="col-12">
								<h4>나의 장바구니 <span class="badge badge-pill badge-dark"><%=basketDtos.size() %></span></h4>
								<hr />
									...
									<table class="table table-bordered text-center">
										...
										%>
											<tr>
												...
												<td>
													<p><%=NumberUtil.numberWithComma((basketDto.getPrice()-basketDto.getDiscountPrice())*basketDto.getAmount()) %></p>
												</td>
												<td>
													<p><%=NumberUtil.numberWithComma(basketDto.getPoint()*basketDto.getAmount()) %>p</p>
												</td>
												<td>
